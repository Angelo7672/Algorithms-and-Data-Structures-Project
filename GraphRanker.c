...
typedef struct classifica_s{
	int grafo;
	long long int punteggio;
}classifica_t;

int scansiona(char []);
int creaGrafo(int ,long long int**);
long long int velocizza(long long int** ,int ,int );
long long int dijkstra(catalogo_t* ,long long int** ,coda_t* ,int );
...
long long int inserisci(classifica_t* ,int ,int ,long long int );
long long int cambioalvertice(classifica_t* ,int ,long long int ,int );
...
int main(void){
	...
	//Creazione
	if((matrice=malloc(nodi*sizeof(long long int*)))){					//crea matrice adiacenza
		for(i=0;i<nodi;i++){
			if((matrice[i]=malloc(nodi*sizeof(long long int)))){
...
int creaGrafo(int n,long long int**matrice){				
...
long long int velocizza(long long int**matrice,int i,int j){
...
long long int dijkstra(catalogo_t*v,long long int**matrice,coda_t*coda,int n){
	
	int i,ok,u;
	int heapsize;
	long long int sommacammini;
...
long long int inserisci(classifica_t*classificati,int ultimo,int cont,long long int peso){
...
long long int cambioalvertice(classifica_t*classificati,int cont,long long int peso,int ultimo){
